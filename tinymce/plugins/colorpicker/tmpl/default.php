...
<div class="modal-footer">
    <div id="colorpicker_preview">
        <div id="colorpicker_preview_text">
            <input type="text" id="colorpicker_color" size="8" maxlength="8" value="#000000" class="input-mini" aria-required="true" />
        </div>
        <div id="colorpicker_preview_color" style="background-color: rgb(0, 0, 0);" class="input-mini label">&nbsp;</div>
    </div>
    <button type="button" id="colorpicker_insert" class="btn" onclick="ColorPicker.insert();"><?php echo WFText::_('WF_LABEL_APPLY'); ?></button>
