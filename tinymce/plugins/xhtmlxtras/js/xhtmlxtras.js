...
var XHTMLXtrasDialog = {
    ...
    init : function() {
        ...
        var self = this, ed = tinyMCEPopup.editor, se = ed.selection, n = se.getNode(), element = tinyMCEPopup.getWindowArg('element');
        ...
        }).toggle(!!element).addClass('btn btn-danger');
        
        $('#datetime').next('button').click(function(e) {
            e.preventDefault();
    ...
    insertDateTime : function(id) {
        $('#datetime').val(this.getDateTime(new Date(), "%Y-%m-%dT%H:%M:%S"));
    },
