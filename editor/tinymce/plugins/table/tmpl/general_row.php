...
<div class="container-fluid">
    <div class="row-fluid">
        <label for="rowtype" class="span4">
                <?php echo WFText::_('WF_TABLE_ROWTYPE'); ?></label>
        
            <select id="rowtype" class="span8">
    ...
    <div class="row-fluid">
        <label for="height" class="span4">
            <?php echo WFText::_('WF_TABLE_HEIGHT'); ?></label>
        <input type="text" id="height" value=""
               size="4" maxlength="4" onchange="TableDialog.changedSize();" class="span2" />
