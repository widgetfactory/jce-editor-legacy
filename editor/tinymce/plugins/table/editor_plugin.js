            ...
            each({
                mceInsertTable: function(val) {
                    winMan.open({
                        ...
                        width: 480 + parseInt(ed.getLang('table.table_delta_width', 0)),
                        height: 400 + parseInt(ed.getLang('table.table_delta_height', 0)),
                        inline: 1,
                        popup_css: false
                    }, {
                        plugin_url: url,
                ...
                mceTableRowProps: function() {
                    winMan.open({
                        ...
                        width: 480 + parseInt(ed.getLang('table.rowprops_delta_width', 0)),
                        height: 400 + parseInt(ed.getLang('table.rowprops_delta_height', 0)),
                        inline: 1,
                        popup_css: false
                    }, {
                        plugin_url: url
                ...
                mceTableCellProps: function() {
                    winMan.open({
                        ...
                        width: 480 + parseInt(ed.getLang('table.cellprops_delta_width', 0)),
                        height: 400 + parseInt(ed.getLang('table.cellprops_delta_height', 0)),
                        inline: 1,
                        popup_css: false
                    }, {
                        plugin_url: url
