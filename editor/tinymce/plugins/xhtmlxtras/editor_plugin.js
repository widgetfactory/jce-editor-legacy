        ...
        init : function(ed, url) {          
            ...
            ed.addCommand('mceDel', function() {
                ed.windowManager.open({
                    ...
                    width : 520 + parseInt(ed.getLang('xhtmlxtras.del_delta_width', 0)),
                    height : 400 + parseInt(ed.getLang('xhtmlxtras.del_delta_height', 0)),
                    inline : 1,
                    popup_css : false
                }, {
                    plugin_url : url,
            ...
            ed.addCommand('mceIns', function() {
                ed.windowManager.open({
                    ...
                    width : 520 + parseInt(ed.getLang('xhtmlxtras.ins_delta_width', 0)),
                    height : 400 + parseInt(ed.getLang('xhtmlxtras.ins_delta_height', 0)),
                    inline : 1,
                    popup_css : false
                }, {
                    plugin_url : url,
