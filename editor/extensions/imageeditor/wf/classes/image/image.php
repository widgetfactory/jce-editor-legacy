...
// load filter class
require_once(dirname(__FILE__) . DS . 'filter.php');
...
class WFImage {
    ...
    protected function getFilterInstance($type) {
        ...
        // load the filter
        require_once(dirname(__FILE__) . DS . 'filters' . DS . $type . '.php');

        // Verify that the filter type exists.
        $className = 'WFImageFilter' . ucfirst($type);
        ...
        if (!($instance instanceof WFImageFilter)) {
