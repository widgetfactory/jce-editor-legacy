...
class WFEditor extends JObject {
    ...
    public function getStyleSheets($absolute = false) {
        ...
        $global     = intval($this->getParam('editor.content_css', 1));
        $profile    = intval($this->getParam('editor.profile_content_css', 2));

        switch ($global) {
            // Custom template css files
            case 0 :
                // use getParam so result is cleaned
                $global_custom = $this->getParam('editor.content_css_custom', '');
        ...
        switch ($profile) {
            ...
            case 0 :
            case 1 :
                $profile_custom = $this->getParam('editor.profile_content_css_custom', '');
