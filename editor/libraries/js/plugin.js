...
(function ($) {
    ...
    /**
         ...
         */
    $.String = {
        // Diacritics map - https://github.com/moxiecode/plupload/blob/1.x/src/javascript/plupload.js
        diacritics : [
        ...
        utf8_to_ascii : function(s) {
            var i, map = this.diacritics, len = map.length;
            
            for (i = 0; i < len; i += 2) {
                s = s.replace(map[i], map[i + 1]);
            }
