...
upload: 'Upload',
queue: 'Queue',
upload_exits: 'If file exists: ',
overwrite: 'Overwrite duplicate files',
upload_drop: 'Drag & Drop files here',
file_exists_alert: 'A file with the same name exists in the target folder. Rename the file in the queue or select "Create Unique File Name" from the "If file exists" list.',
