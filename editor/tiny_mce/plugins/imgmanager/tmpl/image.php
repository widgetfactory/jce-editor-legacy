...
<div class="container-fluid">
    <div class="row-fluid span9">
        <div class="row-fluid">
            <label for="src" class="hastip" title="<?php echo WFText::_('WF_LABEL_URL_DESC'); ?>"><?php echo WFText::_('WF_LABEL_URL'); ?></label>
            <td colspan="3"><input type="text" id="src" value="" class="required" />
        </div>
        <div class="row-fluid">
            <label for="alt" class="hastip" title="<?php echo WFText::_('WF_LABEL_ALT_DESC'); ?>"><?php echo WFText::_('WF_LABEL_ALT'); ?></label>
            <td colspan="3"><input id="alt" type="text" value="" class="required" />
        </div>
        <div id="attributes-dimensions">
            <label for="width" class="hastip" title="<?php echo WFText::_('WF_LABEL_DIMENSIONS_DESC'); ?>"><?php echo WFText::_('WF_LABEL_DIMENSIONS'); ?></label>
            <td colspan="3">
        ...
        <div id="attributes-align">
            <label for="align" class="hastip" title="<?php echo WFText::_('WF_LABEL_ALIGN_DESC'); ?>"><?php echo WFText::_('WF_LABEL_ALIGN'); ?></label>
        ...
        <div id="attributes-margin">
            <label for="margin" class="hastip" title="<?php echo WFText::_('WF_LABEL_MARGIN_DESC'); ?>"><?php echo WFText::_('WF_LABEL_MARGIN'); ?></label>
            <td colspan="3">
        ...
        <div id="attributes-border">
            <label for="border" class="hastip" title="<?php echo WFText::_('WF_LABEL_BORDER_DESC'); ?>"><?php echo WFText::_('WF_LABEL_BORDER'); ?></label>
            <td colspan="3">
