...
(function(tinymce) {
    ...
    tinymce.create('tinymce.ui.TableSplitButton:tinymce.ui.SplitButton', {
		 ...
		 */
        renderMenu : function() {
            var t = this, ed = this.editor, m, i = 0, s = t.settings, n, tb, tr, w, context;
    ...
    tinymce.create('tinymce.plugins.TablePlugin', {
        init : function(ed, url) {
            ...
            // Register buttons
            each([
                ['table_insert', 'table.desc', 'mceInsertTable', true],
                    ...
                    ed.parser.addNodeFilter('td', function(nodes) {
                        for (var i = 0, len = nodes.length; i < len; i++) {
                            ...
                            if (!nodes[i].firstChild) {
                                nodes[i].append(new tinymce.html.Node('#text', 3)).value = '\u00a0';
                            }
                        }
                    });
                }
