...
//			f.top -= po.y;
            ...
            // Create DOM objects
			t._addAll(wrapper, 
			 	['div', {id : id, role : 'dialog', 'aria-labelledby': f.type ? id + '_content' : id + '_title', tabindex : -1, 'class' : 'ui-dialog ui-widget ui-widget-content ui-corner-all ui-draggable ui-resizable' + opt},
				 	// title bar
				 	['div', {'class' : 'ui-dialog-titlebar ui-widget-header ui-corner-all ui-helper-clearfix'}, 
						// title
					 	['span', {id : id + '_title', 'class' : 'ui-dialog-title'}, f.title || ''],
						// close button
					...
					// content block
					['div', {id : id + '_content', 'class' : 'ui-dialog-content ui-widget-content', style : 'overflow:hidden;'}],
            ...
            // create iframe
            if (!f.type) {
            	var iframe = DOM.add(id + '_content', 'iframe', {id : id + '_ifr', src : 'javascript:""', frameBorder : 0, style : 'border:0;width:10px;height:10px'});
				DOM.setStyles(iframe, {width : f.width, height : f.height});
            ...
            if (tinymce.isIE6 || (tinymce.isIE && !DOM.boxModel)) {
                DOM.setStyles(overlay, {position : 'absolute', left : vp.x, top : vp.y, width : vp.w - 2, height : vp.h - 2});
            }
        ...
        _startDrag : function(id, se, ac) {
            ...
            function startMove() {
                ...
                if (tinymce.isIE6 || (tinymce.isIE && !DOM.boxModel))
                    DOM.setStyles(blocker, {position : 'absolute', left : vp.x, top : vp.y, width : vp.w - 2, height : vp.h - 2});
                ...
                DOM.add(eb.get(), 'div', {id : 'ui-dialog-placeholder', 'class' : 'ui-widget-content ui-widget-overlay', style : {left : sx, top : sy, width : sz.w, height : sz.h}});
