...
(function(tinymce) {
	...
	tinymce.create('tinymce.themes.AdvancedTheme', {
		...
		renderUI : function(o) {
			...
			n = p = DOM.create('div', {role : 'application', 'aria-labelledby' : ed.id + '_voice', id : ed.id + '_parent', 'class' : 'mceEditor ' + ed.settings.skin + 'Skin' + (s.skin_variant ? ' ' + ed.settings.skin + 'Skin' + t._ufirst(s.skin_variant) : '')});
		...
		_addStatusBar : function(tb, o) {
			...
			n = DOM.add(n, 'div', {id : ed.id + '_path_row', 'role': 'group', 'aria-labelledby': ed.id + '_path_voice', 'class' : 'mcePathRow'});
			
			// WFEditor Path modifications
			
			if (s.theme_advanced_path) {
				DOM.add(n, 'span', {id: ed.id + '_path_voice', 'class' : 'mcePathLabel'}, ed.translate('advanced.path') + ': ');
				//DOM.add(n, 'span', {}, ': ');
			} else {
				DOM.add(n, 'span', {}, '&#160;');
			}
		...
		_nodeChanged : function(ed, cm, n, co, ob) {
			...
			if (s.theme_advanced_path && s.theme_advanced_statusbar_location) {
				p = DOM.get(ed.id + '_path') || DOM.add(ed.id + '_path_row', 'span', {id : ed.id + '_path', 'class' : 'mcePathPath'});
